      ...
      <div style={modalStyle} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={bodyStyle}>
          ...
          <div style={sectionTitleStyle}>
            All ({all.length}) <span style={{ opacity: 0.5, fontWeight: 400 }}>{loading && '· loading…'}</span>
          </div>
...
const sectionTitleStyle: CSSProperties = { fontSize: 11, fontWeight: 600, opacity: 0.85, textTransform: 'uppercase', letterSpacing: 0.4, marginTop: 4 }
