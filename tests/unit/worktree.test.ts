/**
 * Worktree primitive tests. We exercise the parsing logic directly, and
 * use a stub `GitRunner` to verify removeWorktree / findStaleWorktrees
 * issue the right git argv without actually shelling out.
 */
